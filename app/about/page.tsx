    ...
    <section className="relative min-h-screen pl-6 md:pl-28 pr-6 md:pr-12 py-16 md:py-24">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <Section index="05" label="Built With">
          <p>
            A Python data pipeline handles ingestion, scoring and the scheduled refreshes, publishing
        ...
        <Section index="06" label="Disclaimer">
          <p className="text-muted-foreground">
            ...
            not judgements about any company&apos;s prospects. Data is sourced from third parties and
            may contain errors or omissions. Verify independently before acting on anything here.
          </p>
        </Section>
