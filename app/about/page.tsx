...
import { Linkedin, Mail, ArrowUpRight, Check, X, FileSpreadsheet, ShieldCheck, Database, Layers, Scale, TrendingUp, AlertTriangle } from "lucide-react"
...
function SectionHeader({
  ...
  return (
    <div id={id} className="scroll-mt-12 flex flex-col sm:flex-row sm:items-baseline justify-between gap-1.5 border-b border-border/40 pb-3 mb-6">
...
export default function AboutPage() {
  return (
    <section className="relative min-h-screen pl-6 md:pl-28 pr-6 md:pr-12 py-16 md:py-24">
      ...
      {/* Left vertical rail label -- mirrors SCREEN / RESULTS / TEAR SHEET */}
      <div className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2 hidden md:block pointer-events-none">
        <span className="font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground -rotate-90 origin-left block whitespace-nowrap select-none">
          ABOUT
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* Master Header Block */}
        <div className="mt-8 pb-10 border-b border-border/40">
          ...
          <h1 className="mt-2.5 font-[family-name:var(--font-bebas)] text-[clamp(2.5rem,6vw,4.5rem)] leading-[0.92] tracking-tight text-foreground">
            About DealScope
          </h1>
          <p className="mt-5 max-w-3xl font-sans text-base md:text-lg leading-relaxed text-foreground/90 text-pretty">
            A free, login-free acquisition screening workbench that ranks NSE-listed Indian companies
            against their own sector peers and attaches an indicative valuation range to each one.
          </p>

          {/* Live Universe HUD Telemetry Strip */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-8 font-mono text-xs">
        ...
        {/* 2-Column Layout: Sidebar TOC (Desktop) + Main 7-Chapter Dossier */}
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
          {/* Desktop Left Rail Navigation (Col 1-3) */}
          <div className="lg:col-span-3">
            <AboutNav />
          </div>

          {/* Main Content Body (Col 4-12) */}
          <div className="lg:col-span-9 space-y-16 md:space-y-24">
            ...
            <section id="01-mission">
              <SectionHeader
                ...
                subtitle="The sector-relative mandate"
              />
            ...
            <section id="07-integrity" className="pt-12 md:pt-16 border-t border-border/30">
              ...
              <div className="mt-12 pt-8 border-t border-border/40 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <span className="font-mono text-xs uppercase tracking-wider text-muted-foreground">
                  Quantitative Engineering by Ram
                </span>
